...
getgenv().bladehat = "CorruptLordSword"
...
Character[getgenv().bladehat].Handle.AccessoryWeld.Part1 = Handle
Character[getgenv().bladehat].Handle.AccessoryWeld.C1 = CFrame.new(3,2,0,-1,0,0,0,-1,0,0,0,1)
